...
<img src="./docs/goflarecar-logo.png" alt="Logo of a gopher driving a racecar with flames out the
back" height="100px" />
...
The logo was generated by Gemini with Nano Banana. It is an adaption of the [Go gopher by Renee
French](https://go.dev/wiki/Gopher) which is itself licensed under the Creative Commons 4.0
